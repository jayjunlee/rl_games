...
class ModelBuilder:
    def __init__(self):
        ...
        self.model_factory.register_builder('central_value', lambda network, **kwargs: models.ModelCentralValue(network))
        self.model_factory.register_builder('continuous_a2c_tanh', lambda network, **kwargs: models.ModelA2CContinuousTanh(network))
